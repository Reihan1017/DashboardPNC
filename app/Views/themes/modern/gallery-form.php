...
<!-- Pastikan filepicker.css & filepicker.js sudah dimuat di layout -->
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    addImageBtn.addEventListener("click", function () {
        filepicker({
            multiple: true, // bisa pilih lebih dari 1 gambar
            onSelect: function(files) {
                files.forEach(function(file) {
                    // URL gambar hasil upload
                    ...
                    let newItem = `
                        <li class="thumbnail-item">
                            ...
                            <div class="img-container">
                                <img class="jwd-img-thumbnail" src="${imageUrl}" />
                            </div>
                        </li>`;
                    document.getElementById("list-image-container").insertAdjacentHTML("beforeend", newItem);
                });
            }
        });
    });
