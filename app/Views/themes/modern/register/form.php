...
<div class="card-body">
	...
	<form action="<?=current_url()?>" method="post" accept-charset="utf-8">
			...
			<div class="row">
				<div class="col-auto">
					<select name="gender" class="form-select register-input">
						<option value="L" <?=set_select('gender', 'L')?>>Bapak/Akang</option>
						<option value="P" <?=set_select('gender', 'P')?>>Ibu/Teteh</option>
					</select>
				</div>
				<div class="col ps-0">
		...
		<div class="mb-3">
			...
			<p class="small">Kemana kami akan menginformasikan Anda?</p>
		</div>
		<div class="mb-3">
