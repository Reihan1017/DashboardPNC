...
namespace App\Modules\Chained_dropdown\Controllers;
use App\Modules\Chained_dropdown\Models\ChainedDropdownModel;
...
class Chained_dropdown extends \App\Controllers\BaseController
{
	...
	public function index()
	{
		...
		$this->view('chained-dropdown-result.php', $data);
	}
	...
	private function setData($id_wilayah_kelurahan = null) {
		...
		$wilayah = new \App\Modules\Wilayah\Controllers\Wilayah;
